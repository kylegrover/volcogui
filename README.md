...
**Latest Release:** [v0.3.0-beta](https://github.com/kylegrover/volcogui/releases/tag/v0.3.0-beta)

**Windows:** Download `VolcoGUI_v0.3.zip`, extract, and run `VolcoGUI.exe`. No installation required - Volco is bundled.
